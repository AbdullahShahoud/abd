...
// class FormsForget extends StatefulWidget {
//   const FormsForget({super.key});

//   @override
//   State<FormsForget> createState() => _FormsState();
// }

// class _FormsState extends State<FormsForget> {
//   @override
//   Widget build(BuildContext context) {
//     return Form(
//         key: context.read<LoginCubit>().keyChangePassword,
//         child: Column(
//           children: [
//             FromFields(
//                 vaildet: (value) {
...
//                 controller: context.read<LoginCubit>().controllerEmailChangePassword!,
//                 icon: Icon(
